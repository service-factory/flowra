...
import { CalendarTask } from '@/app/(main)/calendar/types/calendar';
import { getPriorityIcon, getGoogleCalendarColor } from '@/app/(main)/calendar/utils/calendarUtils';
...
export const CalendarTaskCard = memo(function CalendarTaskCard({ 
  task, 
  onTaskClick, 
  isCompact = false
