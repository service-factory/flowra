...
-- 기존 정책 삭제 (있다면)
DROP POLICY IF EXISTS "Users can view own discord settings" ON public.discord_user_settings;
DROP POLICY IF EXISTS "Users can insert own discord settings" ON public.discord_user_settings;
DROP POLICY IF EXISTS "Users can update own discord settings" ON public.discord_user_settings;
DROP POLICY IF EXISTS "Users can delete own discord settings" ON public.discord_user_settings;
...
DROP TRIGGER IF EXISTS trigger_update_discord_user_settings_updated_at ON public.discord_user_settings;
